...
export const navbarConfig: ComponentConfig<NavbarProps> = {
  ...
  defaultProps: {
            ...
            links: [
              {
                ...
                description: "Browse our individually styled rooms.",
                subSections: [],
              },
              {
                label: "Cabins & Villas",
                ...
                description: "Private cabins for couples and families.",
                subSections: [],
              },
              {
                label: "The Property",
                href: "/property",
                icon: "FluentTent28Filled",
                description: "Grounds, gardens, and shared spaces.",
                subSections: [],
              },
            ],
          },
    ...
    ctaHoverTextColor: "#FFFFFF",
    ctaBorderColor: "#111827",
    ctaHoverBorderColor: "#1f2937",
