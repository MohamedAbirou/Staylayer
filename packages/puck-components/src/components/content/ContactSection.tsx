...
export const ContactSection = ({
  ...
  emailAddress = "contact@staylayer.com",
  emailLabel = "contact@staylayer.com",
...
export const contactSectionConfig: ComponentConfig<ContactSectionProps> = {
  ...
  defaultProps: {
    ...
    heading: "Let's Connect",
    description:
      "Have a question about StayLayer or need help with your account? Fill out the form and our team will get back to you quickly.",
    bulletItems: [
      { text: "Onboarding & setup guidance" },
      { text: "Feature walkthroughs" },
      { text: "Partnership opportunities" },
