...
import OTASlider from "@/components/otas";
import FinancialToolsTabs from "@/components/financialToolsTabs";
...
export default function Home({ translations, cmsPage }) {
      ...
      <main id="home">
        <div className="hero h-screen space-y-8 min-h-[700px] overflow-x-hidden">
          ...
          <div className="overflow-x-hidden">
            <h6 className="mt-20 mb-5">{t("home.hero.otaKicker")}</h6>
            <OTASlider direction={1} offset={6} />
          </div>
        </div>

        <FinancialToolsTabs t={t} />
