export function MdiLightChevron(props) {
  return (
...
export function Logo(props) {
  return (
    ...
    >
      <path
        fill="#E84855"
        d="m831.2 9.2-259.8 702.2c-117.8-70.9-105.8-174.3-105.8-174.3l173.1-527.9z"
      />
      <path
        fill="#143642"
        d="m195 9.2 307.9 841.7h-182.8l-307.9-841.7z"
        fillRule="evenodd"
      />
      <path
        fill="#143642"
        d="m1138.1 9.2v841.7h-188.8v-841.7z"
        fillRule="evenodd"
      />
      <path fill="#143642" d="m1836.6 686.4v164.7h-531.5v-841.7h188.8v675.8z" />
      <path fill="#143642" d="m2468.3 686.4v164.7h-531.5v-841.7h188.8v675.8z" />
      <path
        fill="#143642"
        d="m3240.7 850.7h-212.8l-149.1-275.4h-121.5v275.4h-188.8v-841.7h343.9c202.1 0 317.5 90.2 317.5 275.3 0 141.9-60.1 230.9-169.6 269.4zm-187.5-559.2c0-92.6-54.1-127.4-151.6-127.4h-145.5v257.3h145.5c96.2 0 151.6-36.1 151.6-129.9z"
      />
      <path
        fill="#143642"
        d="m3839.5 9.2h-199.6l-341.5 841.7h192.4l113-306.6 129.9-335.7 239.3 642.3h200.8z"
        fillRule="evenodd"
      />
    </svg>
  );
...
export function MatrialIconsGroup(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsMenuBook(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsStars(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsLogin(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsAttachMoney(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsBarChart(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsContact(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsInfo(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsWork(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsHotel(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsStoreFront(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsAgriculture(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsHome(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsApartment(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsCalenderMonth(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsSyncAlt(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsEvenetAvailable(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsTrendingUp(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MatrialIconsWeb(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export function MaterialSymbolsLightGlobe(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function MdiCalendarSyncOutline(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function MdiViewDashboardOutline(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function MdiCoffee(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function FluentTent28Filled(props) {
  return (
...
export function MaterialSymbolsVerified(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function MaterialSymbolsPolicy(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
